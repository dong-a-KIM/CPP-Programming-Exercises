#pragma once
#include "Canvas10_3.h"
#include "VariousMonsters10_3.h"
#include "Human10_3.h"
#include "Matrix10_3.h"
#include <windows.h>
#define MAXMONS 8
...
public:
	...
	void play(int maxwalk, int wait) {
		...
		if (_kbhit()) {
			...
			if (ch == 224) {
					ch = _getche();
					((Tuman*)(pMon[nMon - 1]))->moveHuman(world.Data(), xMax, yMax);
			}
			else ((Tuman*)(pMon[nMon - 2]))->moveHuman(world.Data(), xMax, yMax);
		}
